class Booking < NexudusBase
  attr_accessor :id, :resource_id, :resource_name, :resource, :coworker_id, :coworker_full_name, :from_time, :to_time, :online, :updated_by, :friendly_start_date, :friendly_dates, :friendly_date, :friendly_times, :duration_in_minutes, :duration_in_hours, :repeat_series_unique_id, :repeat_booking, :repeats, :repeat_every, :repeat_until, :repeat_on_mondays, :repeat_on_tuesdays, :repeat_on_wednesdays, :repeat_on_thursdays, :repeat_on_fridays, :repeat_on_saturdays, :repeat_on_sundays

class Booking < NexudusBase
  attr_accessor :id, :resource_id, :resource_name, :coworker_id, :coworker_full_name, :from_time, :to_time, :online, :updated_by, :friendly_start_date, :friendly_dates, :friendly_date, :friendly_times
